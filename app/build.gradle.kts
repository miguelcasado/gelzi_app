plugins {
    ...
    id("org.jetbrains.kotlin.plugin.compose") // 🔥 Plugin necesario para Kotlin 2.0
}

android {
    namespace = "app.gelzi.gelziapp"
    compileSdk = 35

    defaultConfig {
        applicationId = "app.gelzi.gelziapp"
        minSdk = 27
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
